...
function showViewer() {
    ...
    Autodesk.Viewing.Initializer(options, function() {
        ...
        if (obra == "Duo Salvador Norte") {
            //var documentId1 = 'urn:dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6d2djaWloemhodW11Z2J6Z29jc2dhaXZ0ZWpjbXZldHotcjIvUHIlQzMlQTlkaW8lMjBDT1JSSUdJRE8lMjAzJTIwKDMpLnJ2dA==';
            //dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6d2djaWloemhodW11Z2J6Z29jc2dhaXZ0ZWpjbXZldHotc25yL1NOUl9IQUJfRklYXzAyXzIwMTlfUjEucnZ0
...
$('#obras').on('change', function() {
    ...
    $('[apagar="forge"]').html(`<div role="tabpanel" class="tab-pane fade in active" id="forgeViewer" class="col-xs-12 col-md-8"></div>
